...
class CameraCalibration:
    ...
    def calibrate_from_camera(
        ...
        Args:
            camera_index: Kept for backward compatibility (ignored with Picamera2).
            camera_resolution: Camera capture resolution as (width, height).
        ...
        Raises:
            RuntimeError: If Picamera2 is unavailable.
        ...
        if Picamera2 is None:
            raise RuntimeError(
                "picamera2 is required for camera capture. Install with: pip install picamera2"
            )
...
def _build_cli_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Interactive rpicam camera calibration")
    parser.add_argument("--camera-width", type=int, default=1280, help="Camera width in pixels")
    parser.add_argument("--camera-height", type=int, default=720, help="Camera height in pixels")
    ...
    parser.add_argument(
        "--output",
        type=str,
        default="rpi/localization/config/camera_calibration.yaml",
